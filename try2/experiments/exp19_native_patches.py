...
class Config(ExperimentConfig):
    EXPERIMENT_NAME = "exp19_native_patches"
    DESCRIPTION = "Stage 2 fine segmenter trained on native-resolution 128x128 patches"
...
def main():
    ...
    logger.info(f"Patch jitter val   : {cfg.PATCH_JITTER_VAL}")
    ...
    print("\n" + "=" * 70)
    print("STAGE 2: NATIVE-PATCH FINE SEGMENTER TRAINING")
    print("=" * 70)
