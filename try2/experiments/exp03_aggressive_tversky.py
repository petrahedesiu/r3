...
class Config(ExperimentConfig):
    EXPERIMENT_NAME = "exp03_aggressive_tversky"
    DESCRIPTION = "More aggressive Tversky loss (alpha=0.2, beta=0.8) to penalize missed FG"
...
def main():
    ...
    print(f"  Tversky alpha   : {Config.TVERSKY_ALPHA} (FP weight)")
    print(f"  Tversky beta    : {Config.TVERSKY_BETA} (FN weight)")
