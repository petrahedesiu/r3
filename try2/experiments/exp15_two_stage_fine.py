...
class Config(ExperimentConfig):
    EXPERIMENT_NAME = "exp15_two_stage_fine"
    DESCRIPTION = "Two-stage pipeline Stage 2: fine 3-class segmenter on bbox crops"
...
def main():
    ...
    print("\n" + "=" * 70)
    print("STAGE 2: FINE SEGMENTER TRAINING")
    print("=" * 70)
