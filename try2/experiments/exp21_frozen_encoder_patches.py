...
class Config(ExperimentConfig):
    EXPERIMENT_NAME = "exp21_frozen_encoder_patches"
    DESCRIPTION = "Frozen B4 encoder + native 128x128 patches (anti-overfitting)"
...
def main():
    ...
    logger.info(f"Trainable params   : {trainable_params:,} (encoder frozen)")
    ...
    print("\n" + "=" * 70)
    print("STAGE 2: FROZEN ENCODER + NATIVE-PATCH TRAINING")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("END-TO-END EVALUATION WITH NATIVE PATCHES")
    print("=" * 70)
    ...
    print(f"")
    print(f"  Training (encoder frozen, {trainable_params:,} trainable params):")
