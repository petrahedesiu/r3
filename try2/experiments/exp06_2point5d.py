...
class Config(ExperimentConfig):
    EXPERIMENT_NAME = "exp06_2point5d"
    DESCRIPTION = "2.5D input: 5 adjacent slices as channels for inter-slice context"
...
def main():
    ...
    print(f"Input channels: {cfg.IN_CHANNELS} (center +/- {cfg.N_ADJACENT} slices)")
    ...
    results["n_adjacent"] = cfg.N_ADJACENT
    results["in_channels"] = cfg.IN_CHANNELS
    results["config"] = {
